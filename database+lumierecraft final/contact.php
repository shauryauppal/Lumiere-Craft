...
<div class="demo-layout-waterfall mdl-layout mdl-js-layout">
  ...
  <main class="mdl-layout__content">
	...
	<b>
  <center>
  <form name="myform" method="get" action="insert.php" style="font-size:1em;border:3px solid black">
  <fieldset>
  <legend style="color:red;font-size:2.5em;border:1.4px solid red">CONTACT FORM</legend>
  NAME:<input type="text" name="name" maxlength=20 required><br><br>
  EMAIL ID:<input type="email" name="emailid" required><br><br>
  ADDRESS:<input type="text" maxlength=100 name="address"><br><br>
  PHONE NUMBER:<input type="tel" maxlength=10 name="phonenumber"><br><br>
  ITEM NAME:<input type="text" name="itemname"><br><br>
   COMMENT/QUERIES:<input type="text" maxlength=600 name="comment"><br><br>
   <input type="submit">
    <input type="reset">
     </fieldset>
      </form>
